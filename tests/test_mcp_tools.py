...
class TestMcpTools:
    ...
    async def test_request_yes_no_input_tool_true(self, mock_ask_yes_no, mock_print):
        """Test yes/no input tool returning True."""
    ...
    @patch('src.main.console.print')
    @patch('src.main.ask_yes_no')
    async def test_request_yes_no_input_tool_false(self, mock_ask_yes_no, mock_print):
